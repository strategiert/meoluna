...
- "none": Kein Spielprinzip passt klar (z.B. freies Schreiben, Musik mit Ton, offene Diskussionen, komplexe Experimente).
...
{ "engine": "movement-space" | "mixing-balance" | "building-construct" | "time-sequence" | "detective-evidence" | "sort-match" | "none", "reason": "ein kurzer Satz" }`;
